    ...
    try {
      ...
      if (isLoggedin) {
        ...
        switch (isLoggedin.data.userRole) {
          case 'store': //store
            toast.success('Login Success as an store')
      ...
      >
        <Grid container>
          ...
          <Grid
            ...
            md={7}
            sx={{
              backgroundImage: "url(https://assets-global.website-files.com/6292e94efb599abaf1d68606/62993cb694ea0f21ace40405_alcohol-p-1600.jpeg)",
